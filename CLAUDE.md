...
| `js/input.js` | keyboard/touch → `keys` flags: `L R` move, `J` jump/menu-up, `A` attack/buy, `E` build menu, `T` trade with villager, `U` teleport; plus direct toggles (`Y` pause, `Q` quit to title, win-screen name typing) |
